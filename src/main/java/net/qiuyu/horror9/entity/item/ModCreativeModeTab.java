    ...
    public static final RegistryObject<CreativeModeTab> HORROR9_TAB = CREATIVE_MODE_TABS.register("horror9_tab",
            ()-> CreativeModeTab.builder().icon(()->new ItemStack(ModItems.NO1_SPAWN_EGG.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.CORRUPTION_LOG.get());
                        pOutput.accept(ModItems.CORRUPTION_WOOD.get());
                        pOutput.accept(ModItems.CORRUPTION_STRIPPED_LOG.get());
                        pOutput.accept(ModItems.CORRUPTION_STRIPPED_WOOD.get());
                        pOutput.accept(ModItems.CORRUPTION_PLANKS.get());
                        pOutput.accept(ModItems.CORRUPTION_LEAVES.get());
                    })
                    .build());
