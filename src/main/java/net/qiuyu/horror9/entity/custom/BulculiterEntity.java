...
public class BulculiterEntity extends Monster implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public BulculiterEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    private PlayState predicate(AnimationState<BulculiterEntity> event) {
    ...
    private PlayState attackPredicate(AnimationState<BulculiterEntity> event) {
        if (this.swinging) {
